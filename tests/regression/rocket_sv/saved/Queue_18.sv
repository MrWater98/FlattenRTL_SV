...
module Queue_18(
  ...
  input  [1:0]  io_enq_bits_id,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [1:0]  io_deq_bits_id,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  assign io_deq_bits_id = ram[1:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_addr = ram[32:2];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_len = ram[40:33];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_size = ram[43:41];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_burst = ram[45:44];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_lock = ram[46];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_cache = ram[50:47];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_prot = ram[53:51];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_qos = ram[57:54];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_echo_tl_state_size = ram[61:58];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_echo_tl_state_source = ram[66:62];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_wen = ram[67];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
