...
module ALU(
  ...
  wire [31:0] _io_adder_out_T_3 = io_in1 + in2_inv + {31'h0, io_fn[3]};	// src/main/scala/rocket/ALU.scala:43:29, :69:20, :71:36, :105:50
  wire        slt =
    io_in1[31] == io_in2[31] ? _io_adder_out_T_3[31] : io_fn[1] ? io_in2[31] : io_in1[31];	// src/main/scala/rocket/ALU.scala:45:35, :71:36, :75:{8,15,24,34,56}, :76:8
  ...
  wire [31:0] out = io_fn == 4'h0 | io_fn == 4'hA ? _io_adder_out_T_3 : shift_logic;	// src/main/scala/rocket/ALU.scala:71:36, :89:83, :105:58, :110:{16,23,40,49}
