...
module AXI4Fragmenter(
  ...
  wire [7:0]  support1 =
    {5'h0,
     {3{{addr[31:30], addr[27], addr[25], addr[16], addr[13]} == 6'h0
          ...
          | {addr[31:30] ^ 2'h2, addr[27], addr[25], addr[16]} == 5'h0}}}
  ...
  wire [7:0]  _support1_T_79 =
    {5'h0,
     {3{{addr_1[31:30], addr_1[27], addr_1[25], addr_1[13]} == 5'h0
          ...
          | {addr_1[31:30] ^ 2'h2, addr_1[27], addr_1[25]} == 4'h0}}}
  ...
  Queue_29 deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                     (clock),
    .reset                     (reset),
  ...
  Queue_29 deq_q_1 (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                     (clock),
    .reset                     (reset),
  ...
  Queue_31 in_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
