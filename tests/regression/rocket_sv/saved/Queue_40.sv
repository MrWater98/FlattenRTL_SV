...
module Queue_40(
  ...
  ram_2x48 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    .W0_data
      ({1'h0,
        ...
        io_enq_bits_size,
        2'h0,
        io_enq_bits_opcode})	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95
  );
  ...
  assign io_deq_bits_sink = _ram_ext_R0_data[13];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_denied = _ram_ext_R0_data[14];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_data = _ram_ext_R0_data[46:15];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_corrupt = _ram_ext_R0_data[47];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
