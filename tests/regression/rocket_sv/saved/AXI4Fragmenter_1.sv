...
module AXI4Fragmenter_1(
  ...
  Queue_49 deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_49 deq_q_1 (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_51 in_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
