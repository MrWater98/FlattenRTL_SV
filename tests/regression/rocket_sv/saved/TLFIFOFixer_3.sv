...
module TLFIFOFixer_3(
  ...
  wire [2:0]  _a_id_T_39 =
    {{nodeIn_a_bits_address[31],
      ...
      nodeIn_a_bits_address[16]} == 4'h0,
     {1'h0,
      {nodeIn_a_bits_address[31],
       nodeIn_a_bits_address[27],
       nodeIn_a_bits_address[25],
       nodeIn_a_bits_address[16],
       ~(nodeIn_a_bits_address[13])} == 5'h0}
       | {2{{nodeIn_a_bits_address[31], ~(nodeIn_a_bits_address[27])} == 2'h0}}}
    | ({~(nodeIn_a_bits_address[31]),
        nodeIn_a_bits_address[27],
        nodeIn_a_bits_address[25],
        nodeIn_a_bits_address[16]} == 4'h0
    ...
    | ({nodeIn_a_bits_address[31],
        ...
        nodeIn_a_bits_address[13]} == 5'h0
         ? 3'h6
         : 3'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:52:29, :137:{31,41,46,59}, src/main/scala/tilelink/FIFOFixer.scala:74:62
  wire [2:0]  a_id =
    {_a_id_T_39[2],
     _a_id_T_39[1:0]
       | {{nodeIn_a_bits_address[31],
           ...
           nodeIn_a_bits_address[25],
           ~(nodeIn_a_bits_address[16])} == 4'h0,
          1'h0}};	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}
  ...
  wire        d_first = d_first_first & nodeOut_d_bits_opcode != 3'h6;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1205:17, src/main/scala/tilelink/Edges.scala:232:25, src/main/scala/tilelink/FIFOFixer.scala:69:{42,63}
  ...
  reg  [17:0] SourceIdFIFOed;	// src/main/scala/tilelink/FIFOFixer.scala:109:35
  ...
  wire [17:0] SourceIdSet = _GEN ? _SourceIdSet_T[17:0] : 18'h0;	// src/main/scala/chisel3/util/OneHot.scala:58:35, src/main/scala/tilelink/FIFOFixer.scala:74:21, :109:35, :110:36, :113:50, :114:21
  ...
  wire [17:0] SourceIdClear = _GEN_0 ? _SourceIdClear_T[17:0] : 18'h0;	// src/main/scala/chisel3/util/OneHot.scala:58:35, src/main/scala/tilelink/FIFOFixer.scala:75:21, :109:35, :111:38, :116:36, :117:23
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      SourceIdFIFOed <= 18'h0;	// src/main/scala/tilelink/FIFOFixer.scala:109:35
    end
    else begin
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stalls_id = _RANDOM[1'h1][8:6];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :79:30
        stalls_id_1 = _RANDOM[1'h1][11:9];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :79:30
        SourceIdFIFOed = _RANDOM[1'h1][29:12];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :109:35
      `endif // RANDOMIZE_REG_INIT
    end // initial
